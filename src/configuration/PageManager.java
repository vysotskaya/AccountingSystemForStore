...
public class PageManager {
    ...
    public static final String SHOW_ALL_RECORDS_COMMAND = "/accountingsystem?command=showallrecords";
    public static final String SHOW_ALL_EMPLOYEES_COMMAND = "/accountingsystem?command=showallemployees";
