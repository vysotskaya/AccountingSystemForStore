...
<head>
  ...
  <title>Запрещённые товары</title>
  <style>
  ...
  <div class="container">
    ...
    <div class="col-sm-4" style="margin-top:10px;">
      ...
      <form class="form-inline text-right" role="form">
        <input type="hidden" name="page" value="forbiddenproductspage.jsp" />
            ...
            <tr>
              <td>
                <div class="alert alert-warning text-center" style="margin-top: 30px;">
                  <h5>На складе отсутствуют запрещённые товары.</h5>
                </div>
              </td>
            </tr>
          </c:when>
          <c:otherwise>
            <c:forEach var="record" items="${list}">
              <tr>
                ...
                <td style="width: 20%;">
                  <c:out value="${record.product.acount}"/> <c:out value="${record.product.measuring_unit}"/>
                </td>
                <td style="width: 20%;">
                  <c:out value="${record.product.customsRegimeType.regime_name}"/>
                </td>
                <td style="width: 20%;">
