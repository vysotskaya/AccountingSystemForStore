  ...
  <div class="container">
    ...
    <div class="col-sm-4" style="margin-top:10px;">
      ...
      <form class="form-inline text-right" role="form">
        <input type="hidden" name="page" value="productspage.jsp" />
          ...
          <c:otherwise>
            <c:forEach var="record" items="${list}">
              <tr>
                ...
                <td style="width: 17%;">
                  <c:out value="${record.storeArea.storearea_name}"/>
                </td>
                <td style="width: 17%;">
                  <c:out value="${record.sender.sender_name}"/>
                </td>
                <td style="width: 17%;">
                  <c:out value="${record.receiver.receiver_name}"/>
                </td>
              </tr>
            </c:forEach>
          </c:otherwise>
